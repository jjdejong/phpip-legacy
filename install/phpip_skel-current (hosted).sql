...
GRANT SELECT ON phpip.* TO 'dejon198_phpip'@'localhost'; 
GRANT UPDATE (last_login) ON TABLE actor TO 'dejong198_phpip'@'localhost';
CREATE USER 'dejon198_phpipuser'@'%' IDENTIFIED BY 'changeme'; 
GRANT ALL ON dejon198_phpip.* TO 'dejon198_phpipuser'@'localhost';
INSERT INTO phpip.actor (login, name, email, password, password_salt) VALUES ('dejon198_phpipuser', 'phpIP User', 'root@localhost', md5('changemesalt'), 'salt');
